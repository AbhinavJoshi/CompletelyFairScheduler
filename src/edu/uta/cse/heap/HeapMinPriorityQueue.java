...
/**
 * Class to implement a min-priority queue with a heap in an ArrayList. Parts
 * borrowed from Heapsort.java
 * 
 * @author Scot Drysdale
 */
public class HeapMinPriorityQueue<E extends Comparable<E>> implements
		MinPriorityQueue<E> {
	 ...
	 */
	private static <E extends Comparable<E>> void minHeapify(ArrayList<E> a,
			int i) {
